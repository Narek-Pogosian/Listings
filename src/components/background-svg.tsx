export default function BackgroundSvg() {
  return (
    <svg
      ...
      fill="currentColor"
      className="pointer-events-none fixed -top-40 -z-20 w-full opacity-25 max-md:hidden dark:opacity-20"
    >
      ...
      <defs>
        ...
        >
          ...
          <stop offset="0.369278" stopColor="#E5FF48"></stop>
          <stop offset="0.588842" stopColor="#FF48ED"></stop>
          <stop offset="0.708333" stopColor="#48BDFF"></stop>
          <stop offset="0.932292" stopColor="#6248FF"></stop>
        </radialGradient>
      </defs>
    </svg>
  );
